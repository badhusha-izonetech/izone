...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="container-custom flex w-full max-w-full items-center justify-between gap-3 px-4">
        {/* Logo */}
        <Link to="/" className="flex min-w-0 items-center gap-3 group">
          <img
            src="/izone-logo.png"
            alt="iZone"
            className="h-10 w-auto max-w-[160px] rounded-md object-contain transition-transform duration-200 group-hover:scale-[1.02] min-[380px]:max-w-[180px] min-[769px]:h-16"
          />
        </Link>
        ...
        {/* Mobile Menu Button */}
        <div className="fixed left-[calc(100vw-3.5rem)] top-4 z-[101] flex flex-shrink-0 items-center gap-2 xl:hidden">
          <button
            type="button"
