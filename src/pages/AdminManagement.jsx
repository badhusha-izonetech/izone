...
export function ClientManagement() {
  ...
  return (
    <CrudPage
      ...
      fields={[
        { key: "name", label: "Client Name", placeholder: "Client company name", required: true },
        { key: "logo", label: "Logo Text", placeholder: "Logo initials" },
...
export function TeamManagement() {
  ...
  const { toast } = useToast();
  const empty = { name: "", role: "", avatar: "", bio: "" };
  const [editing, setEditing] = useState(null);
  const [isModalOpen, setIsModalOpen] = useState(false);
