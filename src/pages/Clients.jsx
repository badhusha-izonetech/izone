...
const getVisibleClients = (clients) => clients.slice(0, MAX_VISIBLE_CLIENTS);
...
const Clients = () => {
  ...
  const clients = getVisibleClients(adminClients);
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="mt-5 pt-20 sm:pt-36 md:pt-40 pb-5 md:pb-24  md:px-8 relative overflow-hidden md:min-h-screen lg:min-h-screen flex items-center">
