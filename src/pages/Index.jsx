...
const Index = () => {
  ...
  return (
    <Layout>
      <AdminPopup />
      <section className="relative overflow-hidden bg-[#e1e8e2] px-4 pt-4 dark:bg-background md:px-8 md:pt-6 xl:min-h-screen">
        ...
        <motion.div
          ...
          className="container-custom relative z-10 flex min-h-[calc(100vh-4rem)] w-full max-w-full min-w-0 items-start pb-6 pt-2 md:min-h-[calc(100vh-7rem)] md:pb-12 md:pt-4 xl:min-h-screen xl:items-center xl:py-6"
        >
          <div className="grid w-full max-w-full min-w-0 items-center justify-items-center gap-8 pt-0 md:pt-8 lg:grid-cols-2 lg:gap-12 xl:gap-16 xl:pt-0">
            ...
            {/* Mobile / small tablet visual — hidden on lg+ */}
            <motion.div
              initial={{ opacity: 0, y: 24, scale: 0.97 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ duration: 0.8, delay: 0.16, ease: [0.22, 1, 0.36, 1] }}
              className="relative w-full flex justify-center lg:hidden py-4"
            >
              <HeroVisualCard />
            </motion.div>

            {/* Desktop / large tablet visual — shown on lg+ */}
            <motion.div
              initial={{ opacity: 0, y: 24, scale: 0.95 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ duration: 0.82, delay: 0.18, ease: [0.22, 1, 0.36, 1] }}
              className="relative hidden w-full lg:flex lg:items-center lg:justify-center xl:justify-end"
            >
              <div className="relative w-full flex items-center justify-center lg:justify-center xl:justify-end [isolation:isolate]">
                <HeroVisualCard />
              </div>
            </motion.div>
          </div>
