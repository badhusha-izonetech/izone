...
const Portfolio = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="portfolio-hero mt-5 pt-20 sm:pt-36 md:pt-40 pb-0 md:pb-24  md:px-8 relative overflow-hidden md:min-h-screen lg:min-h-screen flex items-center">
